...
use Model\Conta\{ContaCorrente, ContaPopanca, SaldoInsuficienteException, Titular};
...
try {
    $primeiraConta->saca(600);
}catch (SaldoInsuficienteException $exception){
    echo "Você não tem saldo pra realizar este saque." . PHP_EOL;
